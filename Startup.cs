        ...
        public void ConfigureServices (IServiceCollection services) {
            ...
            services.AddSwaggerGen (c =>  {
                ...
                c.SwaggerDoc ("v1", new Info {
                    ...
                    TermsOfService = "None", 
                    Contact = new Contact {Name = "Eshwar Rachala", Email = string.Empty, Url = "https://twitter.com/eswarrachala"}, 
                    License = new License {Name = "Local market", Url = "https://eshwarrachala.com/"}
                }); 
